...
const WowModelViewerFixed = dynamic(() => import('./components/WowModelViewerFixed'), {
  ssr: false,
  loading: () => (
...
export default function Home() {
  ...
  const convertToModelViewerItems = useCallback((items: Record<string, Item>) => {
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <Script 
        ...
        onLoad={() => {
          ...
          console.log('Re-established environment variables after script load:');
          console.log('CONTENT_PATH:', window.CONTENT_PATH);
          console.log('WOW_MODEL_VIEWER_PATH:', (window as any).WOW_MODEL_VIEWER_PATH);
          ...
          const debugCheck = setInterval(() => {
            ...
            if (window.CONTENT_PATH !== '/api/wowhead-proxy/modelviewer/classic/') {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {showScrubber && Object.keys(bestItems).length > 0 && (
          <div className="sticky top-4 z-10 mb-8 bg-white rounded-lg shadow-lg border border-gray-200">
