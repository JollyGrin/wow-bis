...
- warsong boots is a quest item, no level, yet it should identify that it's a reward from a quest and use the min level of the quest
- colors are wrong. check gloves of the fang (shows blue border)
- make a readme of the type of data from items, the data needed for the tooltips, data used in the viewer
